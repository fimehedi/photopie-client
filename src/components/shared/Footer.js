        ...
        <footer className="bg-gray-800">
            <div className="container mx-auto px-6 py-10">
                <div className="flex justify-between items-center">
                    <p className="text-gray-200 text-sm font-family-bebas tracking-widest">&copy;PHOTOPIE @{new Date().getFullYear()}. Development by <a href="http://fimehedi.web.app" className="underline" target="_blank" rel="noreferrer">FIMehedi</a> </p>
